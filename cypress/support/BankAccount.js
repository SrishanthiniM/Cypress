...
Cypress.Commands.add('bank', (username, password) => {
  ...
  cy.contains('Configuration').scrollIntoView().should('be.visible').click();
  cy.contains('Bank Accounts').should('be.visible').click()
